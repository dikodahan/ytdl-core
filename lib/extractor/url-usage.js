...
exports.URL_USAGE = {
    ...
    gbnews: {
        usage: "Paste `gbnews:gbn1` / `gbnews:1069`, a watch live page, or a Perception/Simplestream `.m3u8` URL.",
        examples: [
            "gbnews:gbn1",
            "gbnews:1069",
        ...
        notes: "Live HLS via Simplestream streams API (uvid). Perception.tv links are the browser ad-stitched variant of the same live feed. Discover channels at `https://www.gbnews.com/watch/live`.",
    },
...
exports.LIST_URL_USAGE = {
    ...
    gbnews: {
        usage: "Paste `https://www.gbnews.com/watch/live` (or `gbnews:channels`) to list GBN 1/2 channel IDs (Simplestream uvid).",
        ...
        notes: "Entries include Simplestream uvid (`id`) and slug (`display_id` / `gbnews:gbn1`). Extract with `gbnews:{slug|uvid}`.",
    },
    "kaltura-ott": {
