...
exports.URL_USAGE = {
    ...
    mako: {
        ...
        notes: "Mints an Akamai `hdnea` ticket via mass.mako.co.il entitlements, then returns a short-lived playable HLS URL. Channel IDs come from mako.co.il live-TV discovery with a MediaBox fallback — list with `mako:channels`.",
    },
...
exports.LIST_URL_USAGE = {
    ...
    mako: {
        ...
        notes: "Discovers live/linear channels from mako.co.il (`/mako-vod` live rail), merging MediaBox fallbacks for extras the site omits. Returns `mako:{id}` entries (e.g. `mako:k12`).",
    },
    "kaltura-ott": {
