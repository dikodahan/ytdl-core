...
exports.LIST_URL_USAGE = {
    ...
    livenewsnow: {
        usage: "Paste a category URL (`/category/american`, `/category/business`) or `livenewsnow:categories` / `livenewsnow:american` to list channel IDs.",
        examples: [
        ...
        notes: "Category listing returns channel slugs (`display_id`, e.g. `foxnews`). Extract with `livenewsnow:{slug}` or the channel page URL. `listCategories` returns `american` and `business`.",
    },
    "kaltura-ott": {
